...
if (!document.hasFocus()) {
    ...
    var firstSearchNotificationSource = "https://www.bing.com/browserextension/bingsearchplus/firstsearchoverlay";
    ...
    if (promptMktToCompare && browserLanguage && promptMktToCompare == browserLanguage) {
        var changeItBackNotificationSource = "https://go.microsoft.com/fwlink/?linkid=2179704&xid=27&version=" + version + "&bmkt=" + promptMkt;
